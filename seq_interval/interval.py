class Interval:
    ...
    def __add__(self, other):
        ...
        if not (self.is_intersect_with(other) or self.is_adjacent_with(other)):
            raise ValueError("Two Interval must intersect or adjacent")
        dire = self.direction
        if dire == '+':
    ...
    def __sub__(self, other):
        ...
        if  (
            ...
            raise ValueError("other can not split self")
